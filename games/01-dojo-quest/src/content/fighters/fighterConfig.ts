...
import type { Hitbox } from '../../entities/fighterMoves';
...
export function buildFighterConfig(texture: string, animations: FighterAnimations, stats: FighterStats): FighterConfig {
  return {
    texture,
    animations: {
