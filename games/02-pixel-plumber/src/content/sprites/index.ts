...
import { LAMP_SHEET, SKYLINE_SHEET } from './skyline';
import { TILES_BOILER_SHEET, TILES_ROOFTOP_SHEET, TILES_SEWER_SHEET, TILES_SHEET } from './tiles';
...
export const SPRITES: readonly SpriteAssets[] = [
  ...
  { sheet: TILES_BOILER_SHEET, animations: [] },
  ...
  { sheet: DEBRIS_BOILER_SHEET, animations: [] },
  ...
  { sheet: BARON_SHEET, animations: Object.values(BARON_ANIMATIONS) },
  { sheet: SLUDGE_SHEET, animations: Object.values(SLUDGE_ANIMATIONS) },
  { sheet: LEVER_SHEET, animations: Object.values(LEVER_ANIMATIONS) },
  { sheet: SKYLINE_SHEET, animations: [] },
  { sheet: LAMP_SHEET, animations: [] },
];
